<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Describe.aspx.cs" Inherits="shoppingdemo.Describe" %>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="637" >
                ...
                <tr>
                    <td style="background-image: url(Image/购物车/子页中间.jpg); width: 637px; height: 341px">
                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size: 10pt; width: 352px">
                            <tr>
                                <td align="left" style="width: 200px">商品名称：</td>
                             ...
                             <tr style="color: #000000">
                                <td align="left" style="width: 200px">商品类别：</td>
                                <td style="width: 359px">
                                    <asp:TextBox ID="txtKind" runat="server" Enabled="False"></asp:TextBox>
                                </td>
                            </tr>
                            <tr style="color: #000000">
                                <td align="left" style="width: 200px; height: 19px">商品价格：
                                </td>
                                <td colspan="3" style="width: 269px; height: 19px">
                                    <asp:TextBox ID="txtGoodsPrice" runat="server" Enabled="False">0</asp:TextBox>￥</td>
                            </tr>
                            <tr>
                                <td align="left" style="width: 200px; height: 87px">商品图像：
                                </td>
                                <td colspan="3" style="width: 269px; height: 87px">
                                    <asp:Image ID="imgGoodsPhoto" runat="server" Height="103px" Width="90px"></asp:Image>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" style="width: 200px; height: 97px">商品介绍：
                                </td>
                ...
                <tr>
                    <td style="background-image: url(Image/购物车/子页底.jpg); width: 637px; height: 140px"></td>
                </tr>
            </table>
        </div>
    </form>
